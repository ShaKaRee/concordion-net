...
using SummarizingResultRecorder = org.concordion.@internal.SummarizingResultRecorder;

namespace Concordion.NET.Internal
{
    public class ExtendedSummarizingResultRecorder : SummarizingResultRecorder
    {
        #region Properties
        ...
        public ExtendedSummarizingResultRecorder()
        {
